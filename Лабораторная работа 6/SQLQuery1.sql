...
В отчёте должны быть скриншоты по определению связи между двумя таблицами собственной базы 
данных в среде Management Studio (отчёт с определением связи между таблицами с данными
по сотрудникам и должностям к рассмотрению не принимается).
*/
